...
export default function CaseStudiesClient() {
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <div className="container mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="space-y-12">
            {caseStudies.map((study, index) => {
              ...
              return (
                <motion.article key={index} variants={fadeInUp} className="bg-[#141414] rounded-lg border border-[#2a2a2a] overflow-hidden hover:border-[#C9A962]/20 transition-all duration-300">
                  <div className="grid lg:grid-cols-[1fr_2fr] gap-0">
                    <div className="p-8 bg-gradient-to-br from-[#C9A962]/10 to-transparent flex flex-col justify-between">
                      <div>
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-[#C9A962]/20 mb-4" aria-hidden="true">
      ...
      <section aria-label="Call to action" className="py-24 bg-[#0d0d0d] border-t border-[#1a1a1a]">
