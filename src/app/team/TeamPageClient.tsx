...
export default function TeamPageClient() {
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <div className="container mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="grid md:grid-cols-2 gap-8">
            {teamMembers.map((member, index) => (
              <motion.article key={index} variants={fadeInUp} className="group bg-[#141414] rounded-lg border border-[#2a2a2a] overflow-hidden hover:border-[#C9A962]/30 transition-all duration-300">
      ...
      <section aria-label="Work with us" className="py-24 bg-[#0d0d0d]">
